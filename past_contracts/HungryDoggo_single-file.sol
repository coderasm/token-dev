 ...
 * Clarifications
 * 
 *  - every transfer is taxed 15% -> 1% to LP, 2% to charity, 2% to marketing and 10% to the BNB printer.
...
contract HungryDoggo is Context, IERC20, Ownable {
    ...
    address public _charityAddress = 0x000000000000000000000000000000000000dEaD;
